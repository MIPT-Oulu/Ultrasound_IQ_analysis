...
def MAIN_US_analysis(path_data, path_LUT_table):
    ...
    if im.ndim == 3: #if image is not grayscale --> transform to
        im = rgb2gray(im)   
...
if __name__ == "__main__":
    ...
    path_data='C:/KPacs/Imagebox/1.2.840.113619.2.323.550149246864.1622638488.2.dcm'
    #path_data='C:/KPacs/Imagebox/1.2.410.200001.1.1185.3558773928.3.20210603.1115416287.298.2.dcm'
    path_LUT_table = 'C:/ImageQualityAnalysisProjects/ultra/QA_analysis/LUT.xls'
