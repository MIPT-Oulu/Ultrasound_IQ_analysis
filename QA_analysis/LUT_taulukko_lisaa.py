...
"""Tämän koodin ajamalla saa lisättyä LUT taulukkoon antureita. Satu Inkinen"""
import os
import time
import argparse
import yaml
...
for filename in filenames: #Tämä looppi käy dcm tiedostot läpi ja lisää metatiedot taulukkoon
